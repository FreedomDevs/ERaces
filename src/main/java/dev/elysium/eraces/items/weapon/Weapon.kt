...
import dev.elysium.eraces.items.weapon.Weapon.WeaponLoreBuilder.activeAbility
import dev.elysium.eraces.items.weapon.Weapon.WeaponLoreBuilder.base
import dev.elysium.eraces.items.weapon.Weapon.WeaponLoreBuilder.build
import dev.elysium.eraces.items.weapon.Weapon.WeaponLoreBuilder.passiveEffect
...
abstract class Weapon(
    ...
    open val damage: Double,
    open val attackSpeed: Double,
    open val isUnbreakable: Boolean = false,
    open val maxDurability: Int,
    open val options: Map<String, Any> = emptyMap()
) : Item {
     ...
     */
    protected fun resolveBrokenItem(player: Player, stack: ItemStack) {

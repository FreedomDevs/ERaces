...
public class MovementUtils {
    ...
    public static double getSpeedAttributeValue(int effectLevel) {
        ...
        if (effectLevel > 0)
            return SPEED_BASE_ATTRIBUTE * (1 + PotionEffectType.SPEED.getAttributeModifierAmount(Attribute.MOVEMENT_SPEED, effectLevel - 1));
        return SPEED_BASE_ATTRIBUTE * (1 + PotionEffectType.SLOWNESS.getAttributeModifierAmount(Attribute.MOVEMENT_SPEED, -effectLevel - 1));
    }
